                ...
                <div class="col-xl-6 d-none d-xl-block">
                    <div class="box-banner-6">
                        ...
                        <div class="img-testimonials-2 shape-2"><img src="assets/imgs/page/homepage6/testimonial2.png"
                                alt="iori"></div><img class="img-main" src="assets/imgs/page/homepage6/banner.png"
                            alt="iori">
                    </div>
                </div>
                <div class="col-xl-6">
                    <div class="box-banner-right-home6"><span
                            class="title-line line-48 wow animate__animated animate__fadeIn" data-wow-delay=".s">Think.
                            Creative. Solve</span>
                        <h1 class="color-brand-1 mb-20 mt-5 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                        ...
                        <div class="row">
                            <div class="col-lg-10">
                                <p class="font-md color-grey-500 mb-30 wow animate__animated animate__fadeIn"
                                    ...
                                    akgraphicsstudios and stay clear of exclusions. Benefit from the lowest prices and
                        ...
                        <div class="mt-30">
                            <h5 class="color-brand-1 wow animate__animated animate__fadeIn" data-wow-delay=".3s"><a
                                    target="_blank" class="btn btn-brand-1 hover-up"
                                    href="https://calendly.com/anantkamalstudios/30min">Book Your Demo</a></h5>
                        </div>
        ...
        <div class="container">
            <div class="row align-items-end">
                <div class="col-lg-6 mb-20">
                    <h2 class="color-brand-1 mb-0 wow animate__animated animate__fadeIn" data-wow-delay=".s">Connecting
                ...
                <div class="col-lg-6 mb-20 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                    <p class="color-grey-500 font-md mb-20">Find powerful functions that can boost your performance. It
                        ...
                        class="btn btn-default p-0 font-sm-bold hover-up" href="{{route('front.contact')}}">Contact Us
            ...
            <div class="row mt-45">
                <div class="col-lg-4 wow animate__animated animate__fadeIn" data-wow-delay=".s">
                    <div class="card-human">
                        <div class="card-image mb-15"><img src="assets/imgs/page/homepage6/slider1.png" alt="iori">
                        </div>
                ...
                <div class="col-lg-4 wow animate__animated animate__fadeIn" data-wow-delay=".4s">
                    <div class="card-human">
                        <div class="card-image mb-15"><img src="assets/imgs/page/homepage6/slider3.png" alt="iori">
                        </div>
                        <div class="card-info mb-30">
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide head-bg-brand-2">
                                <div class="card-offer-style-3">
                                    ...
                                    <div class="card-info">
                                        <p class="font-sm color-grey-500 mb-15">akgraphicsstudios Visual Drag and Drop
                                ...
                                <div class="card-offer-style-3">
                                    ...
                                    <div class="card-info">
                                        <p class="font-sm color-grey-500 mb-15">Increase business growth by using
                                            akgraphicsstudios tools for broadcasting. Aim at specific audiences by
                            ...
                            <div class="swiper-slide head-bg-2">
                                <div class="card-offer-style-3">
                                    ...
                                    <div class="card-info">
                                        <p class="font-sm color-grey-500 mb-15">Any Lead Generation platform source like
            ...
            <div class="row align-items-end">
                <div class="col-lg-8 col-md-8">
                    <h2 class="color-brand-1 mb-20 wow animate__animated animate__fadeInUp" data-wow-delay=".s">Choose
                        The Best Plan</h2>
                    <p class="font-lg color-gray-500 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">Pick
        ...
        <div class="container">
            <div class="box-cover-border">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="img-reveal"><img class="d-block" src="assets/imgs/page/homepage2/img-marketing.png"
                                alt="iori"></div>
                    </div>
                    <div class="col-lg-6">
                        <div class="box-info-video"><span class="btn btn-tag wow animate__animated animate__fadeInUp"
                            ...
                            <div class="box-button text-start mt-65 wow animate__animated animate__fadeInUp"
                                data-wow-delay=".3s"><a class="btn btn-brand-1 hover-up"
                                    ...
                                    href="https://wa.me/917620237235">Support Center
                        ...
                        @foreach($faqs as $fkey => $faq)
                            <div class="accordion-item wow animate__animated animate__fadeIn">
                                <h5 class="accordion-header" id="{{$fkey}}">
                                    <button class="accordion-button text-heading-5 {{$fkey == 0 ? '' : 'collapsed'}}"
                                        type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{$fkey}}"
                                        aria-expanded="true" aria-controls="collapseOne">{{$faq->title}}</button>
                                </h5>
                                <div class="accordion-collapse collapse {{$fkey == 0 ? 'show' : ''}}" id="collapse{{$fkey}}"
                                    aria-labelledby="{{$fkey}}" data-bs-parent="#accordionFAQ">
                        ...
                        <div class="swiper-slide">
                            <div class="card-guide">
                                ...
                                <div class="card-info">
                                    ...
                                    <p class="font-xs color-grey-500">Aliquam a augue suscipit, luctus neque purus ipsum
