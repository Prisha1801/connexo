      ...
      <div class="row">
       <div class="col-md-12 partner_program">
            <h5 class="partner_program_section" id="headingOne">
                Anantkamal WADEMO Refund Policy
            </h5>
            <p class="label_section">This refund policy provides a balanced approach to transactions with Anantkamal WADEMO, ensuring compliance with applicable laws to protect both customers and the company from potential misuse of the refund process.</p>
        ...
        <div class="col-md-12 partner_program">
         ...
         <div class="col-md-12 partner_program">
          ...
          6. Cancellation Policy
            ...
            <p class="label_section">Users may cancel their subscription anytime, and cancellation will take effect at the end of the current billing cycle. <section>Refunds will not be issued for the remaining period, </section>except under special circumstances reviewed individually by Anantkamal WADEMO. This aligns with <section>The Consumer Protection Act, 2019,</section> allowing discretionary refunds under justifiable conditions.</p>
         ...
         <div class="col-md-12 partner_program">
           ...
           7. Contact and Support
            ...
            <p class="label_section">For any refund-related queries, users are encouraged to reach out to Anantkamal WADEMO’s customer support team, dedicated to responsive and personalized assistance. This support is in line with<section> The Consumer Protection Act, 2019,</section> promoting effective customer service and grievance redressal.</p>
         ...
         <div class="col-md-12 partner_program">
          ...
          8. Refund Process
            ...
            <p class="label_section">To request a refund, users should email <section><a href="mailto:support@anantkamalwademo.online">support@anantkamalwademo.online</a>
         ...
         <div class="col-md-12 partner_program">
          ...
          9. Policy Amendments
            ...
            <p class="label_section">Anantkamal WADEMO reserves the right to modify this refund policy at any time. Changes will take effect immediately upon posting on the Anantkamal WADEMO website. This is in accordance with<section> The Indian Contract Act, 1872, </section>allowing for periodic updates to policies.</p>
