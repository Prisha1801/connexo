  ...
  <section class="section mt-100">
    <div class="container">
      <div class="row">
       <div class="col-md-12 partner_program">
            <h5 class="partner_program_section" id="headingOne">
                Anantkamal WADEMO Cancellation Policy
            </h5>
        ...
        <div class="col-md-12 partner_program">
          ...
          1. Subscription Cancellation
            ...
            <p class="label_section">Users can cancel their subscription at any time by accessing their account settings or contacting Anantkamal WADEMO support. Once canceled, the subscription will remain active until the end of the current billing cycle.<strong> No refunds will be issued</strong> for the unused period of the subscription, in compliance with <strong>The Indian Contract Act, 1872, </strong>which governs user agreements.</p>
     ...
     6. Customer Support
            ...
            <p class="label_section">For any questions or assistance regarding cancellation, users can contact Anantkamal WADEMO customer support via<strong> <a href="mailto:support@anantkamalwademo.online">support@anantkamalwademo.online</a></strong></p>
       ...
       7. Policy Amendments
            ...
            <p class="label_section">Anantkamal WADEMO may update this cancellation policy at its discretion. All changes will take effect upon posting on the Anantkamal WADEMO website, aligning with <strong>The Indian Contract Act, 1872,</strong> allowing amendments to contractual terms as needed.</p>
