            ...
            <div class="row">
                ...
                <div class="col-md-12 partner_program">
                    <h5 class="partner_program_section" id="headingOne">
                        Privacy Policy for akgraphicsstudios WhatsApp Business API Portal
                    </h5>
                ...
                <div class="col-md-12 partner_program">
                    ...
                    <p class="label_section">This Privacy Policy governs how akgraphicsstudios ("we," "our," "us")
                        collects, uses, maintains, and discloses information from users ("you," "your") of the
                        akgraphicsstudios SaaS platform ("Service"). The Service is hosted on the website <a
                            href="https://anantkamalwademo.online/">https://anantkamalwademo.online/</a>.</p>
                </div>
                ...
                <div class="col-md-12 partner_program">
                    ...
                    <p class="label_section">
                        Email: <a href="mailto:support@anantkamalwademo.online">support@anantkamalwademo.online</a><br>
                        Phone: +91 7620237235
                    </p>
                </div>
