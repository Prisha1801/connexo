      ...
      <div class="banner-1">
        <div class="row align-items-center">
          <div class="col-lg-7"><span class="title-line line-48 wow animate__animated animate__fadeIn"
            ...
            <h1 class="color-brand-1 mb-20 mt-10 wow animate__animated animate__fadeIn" data-wow-delay=".2s">We’d love
              to hear<br class="d-none d-lg-block">from you.</h1>
            <div class="row">
              <div class="col-lg-9">
                <p class="font-md color-grey-500 wow animate__animated animate__fadeIn" data-wow-delay=".4s">Request a
                  demo, ask a question, or get in touch here. If you’re interested in working at Iori Coporation, check
                  out our<a class="ml-3" href="#"> careers page.</a></p>
              </div>
            </div>
            <div class="mt-30 wow animate__animated animate__fadeIn" data-wow-delay=".6s">
            <h5 class="color-brand-1 wow animate__animated animate__fadeIn" data-wow-delay=".3s"><a class="btn btn-brand-1 hover-up" target="_blank" href="https://calendly.com/anantkamalstudios/30min">Book Your Demo</a></h5>
            </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
          <div class="card-small card-small-2">
            ...
            <div class="card-info">
              ...
              <p class="font-xs color-grey-500">Email<a class="color-success"
                  href="mailto:support@anantkamalwademo.com">support@anantkamalwademo.com</a><br>For help with a current
                product or service or refer to FAQs and developer tools</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
          <div class="card-small card-small-2">
            ...
            <div class="card-info">
              ...
              <p class="font-xs color-grey-500">Call us to speak to a member of our team.<br>(+91) 93700 98337<br>(+91)
                76202 37235</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
          <div class="card-small card-small-2">
            ...
            <div class="card-info">
              ...
              <p class="font-xs color-grey-500">Contact the sales department about cooperation projects<br>(+91) 93700
                98337</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
          <div class="card-small card-small-2">
            ...
            <div class="card-info">
              ...
              <p class="font-xs color-grey-500">Contact us to open our branches globally.<br>(+91) 93700 98337<br>(+91)
                76202 37235</p>
            </div>
          </div>
        </div>
            ...
            <div class="wow animate__animated animate__fadeInUp" data-wow-delay=".0s">
              <div class="card-offer card-we-do card-contact hover-up">
                ...
                <div class="card-info">
                  ...
                  <p class="font-md color-grey-500 mb-5">Browse customer support articles and step-by-step instructions
            ...
            <div class="wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
              <div class="card-offer card-we-do card-contact hover-up">
                ...
                <div class="card-info">
                  ...
                  <p class="font-md color-grey-500 mb-5">Watch our video tutorials for visual walkthroughs on how to use
                    our features.</p>
                </div>
              </div>
            </div>
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 col-md-7 m-auto text-center"><span
            ...
            <p class="font-md color-grey-500 wow animate__animated animate__fadeIn" data-wow-delay=".2s">Do not miss the
              latest information from us about the trending in the market. By clicking the button, you are agreeing with
