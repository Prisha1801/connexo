            ...
            <div class="row align-items-end">
                ...
                <div class="col-xl-6">
                    <div class="box-banner-right-home6"><span class="title-line line-48 wow animate__animated animate__fadeIn" data-wow-delay=".s">Think. Creative. Solve</span>
                        ...
                        <div class="row">
                            <div class="col-lg-10">
                                <p class="font-md color-grey-500 mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".2s">Utilize WhatsApp's authentic WhatsApp API with Anantkamal WADEMO and stay clear of exclusions. Benefit from the lowest prices and zero markup costs for the Meta API, unlike others which charge 20-25% higher.</p>
                            </div>
                        </div>
                        <div class="mt-30">
                            <h5 class="color-brand-1 wow animate__animated animate__fadeIn" data-wow-delay=".3s"><a target="_blank" href="https://calendly.com/anantkamalstudios/30min">Book Your Demo</a></h5>
                        </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide head-bg-brand-2">
                                <div class="card-offer-style-3">
                                    ...
                                    <div class="card-info">
                                        <p class="font-sm color-grey-500 mb-15">Anantkamal WADEMO Visual Drag and Drop Builder assists in the visual design of the bot. It gives you a bird's-eye view of your bot's entire structure that aids in the creation of a bot that is highly engaging for your business.</p>
                                        <div class="box-button-offer">
                                            <!-- <a class="btn btn-default font-sm-bold pl-0 color-brand-1 hover-up">Learn More
                                                <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                            ...
                            <div class="swiper-slide head-bg-2">
                                <div class="card-offer-style-3">
                                    ...
                                    <div class="card-info">
                                        <p class="font-sm color-grey-500 mb-15">Increase business growth by using Anantkamal WADEMO's tools for broadcasting. Aim at specific audiences by sending messages, reminders, or following-ups to maximize engagement and the possibility of reactivation.</p>
                                        <div class="box-button-offer">
                                            <!-- <a class="btn btn-default font-sm-bold pl-0 color-brand-1 hover-up">Learn More
                                                <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="box-info-video"><span class="btn btn-tag wow animate__animated animate__fadeInUp" data-wow-delay=".0s">Get in touch</span>
                            ...
                            <div class="box-button text-start mt-65 wow animate__animated animate__fadeInUp" data-wow-delay=".3s"><a class="btn btn-brand-1 hover-up" href="{{route('front.contact')}}">Contact Us</a><a class="btn btn-default font-sm-bold hover-up" target="_blank" href="https://wa.me/917620237235">Support Center
                                    <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                                    </svg></a></div>
                        </div>
