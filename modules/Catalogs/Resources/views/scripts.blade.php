        ...
        el: '#template_creator',
            ...
            methods: {
                ...
                handleImageUpload: function (event) {
                    ...
                    axios.post("{{ route('catalog.uploadImage') }}", formData, {
                        headers: {
                ...
                handleVideoUpload: function (event) {
                    ...
                    axios.post("{{ route('catalog.uploadVideo') }}", formData, {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
                    }).then(response => {
                ...
                handlePdfUpload: function (event) {
                    ...
                    axios.post("{{ route('catalog.uploadPdf') }}", formData, {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
                    }).then(response => {
                ...
                submitTemplate: function () {
                    if(!this.isSending){
                        ...
                        axios.post("{{ route('catalog.submitCatalogTemplate') }}", metaTemplate)
                            .then(function (response) {
                                ...
                                window.location.href = "{{ route('catalog.catalogsTemplatesIndex', ['ok' => 1, 'refresh' => 'yes']) }}";
                            })
