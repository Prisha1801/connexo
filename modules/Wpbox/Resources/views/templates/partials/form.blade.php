        ...
        <div class="card-body">
           <!-- Template header - None, Text, Media -->
            ...
            <div class="form-group">
                ...
                <!--<div class="text-right mt-2"> <!-- Add text-right class to align buttons to the right -->
                <!--    <button @click="addBold()" class="btn btn-icon btn-outline-secondary btn-sm" type="button">-->
                <!--        <span class="btn-inner--icon">B</span>-->
                <!--    </button>-->
                <!--    <button @click="addItalic()" class="btn btn-icon btn-outline-secondary btn-sm" type="button">-->
                <!--        <span class="btn-inner--icon">I</span>-->
                <!--    </button>-->
                <!--    <button @click="addCode()" class="btn btn-icon btn-outline-secondary btn-sm" type="button">-->
                <!--        <span class="btn-inner--icon"><></span>-->
                <!--    </button> -->
                <!--    <button  @click="addVariable()" class="btn btn-icon btn-outline-secondary btn-sm" type="button">-->
                <!--        <span class="btn-inner--icon">{{ __('Add variable')}}</span>-->
                <!--    </button>   -->
                <!--</div>-->
