...
Route::prefix('wpbox')->group(function() {
    ...
    Route::group([
        ...
        Route::group([
            ...
            Route::post('/configs/whatsapp', 'DashboardController@storeWhatsappNumber')->name('configs.whatsapp.store');
            Route::get('/configs/whatsapp', 'DashboardController@showWhatsappForm')->name('configs.whatsapp.show');
